# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 12:42:30 2017
...
#mods
    #1.does the table exist if not create if it does truncate
    #2. once finished the load, transform (using a merge) the data into the T_P_TABLES which ALSO 
    #3. final report is written via SQL script into PANDAS and plots created.
    #4. using the email address parsed in from the command line construct the email including summary tables and plots. Attach the Spreadsheet with todays date
     # a.ensure the spreadsheet is branded the hell up
